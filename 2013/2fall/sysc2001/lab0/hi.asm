...
mov     AL, 0x24		; load the ASCII value of the character 'H' into register AL (8 bits wide)
...
out     DX, al		; send the ASCII character in AL out to the display at the port number in DX
mov     AL, 'a'		; load the ASCII value of the character 'H' into register AL (8 bits wide)
out     DX, al		; send the ASCII character in AL out to the display at the port number in DX

mov     AL, 'n'		; load the ASCII value of the character 'H' into register AL (8 bits wide)
out     DX, al		; send the ASCII character in AL out to the display at the port number in DX
mov     AL, 'm'		; load the ASCII value of the character 'H' into register AL (8 bits wide)
out     DX, al		; send the ASCII character in AL out to the display at the port number in DX
...
mov     AL, 'g'		; load the ASCII value of the character 'H' into register AL (8 bits wide)
out     DX, al		; send the ASCII character in AL out to the display at the port number in DX
